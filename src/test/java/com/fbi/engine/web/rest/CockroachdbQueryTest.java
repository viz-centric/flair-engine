...
public class CockroachdbQueryTest {
	
		private Logger log = LoggerFactory.getLogger(getClass());

	    private static final String COCKROACHDB_ID = "1715917d-fff8-44a1-af02-ee2cd41a3611";
	    ...
	    public void setup() {
	        ...
	        connection = connectionRepository.findByLinkId(COCKROACHDB_ID);
	    }
