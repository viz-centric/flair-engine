...
public class RedshiftQueryTest {

    private Logger log = LoggerFactory.getLogger(getClass());

    private static final String REDSHIFT_ID = "1715917d-fff8-44a1-af02-ee2cd41a3610";
    ...
    public void setup() {
        ...
        connection = connectionRepository.findByLinkId(REDSHIFT_ID);
    }
    ...
    public void inOperatorTest() throws Exception {
        ...
        Connection connection = connectionRepository.findByLinkId(REDSHIFT_ID);
