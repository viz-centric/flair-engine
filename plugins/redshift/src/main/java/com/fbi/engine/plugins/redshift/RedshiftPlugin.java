...
public class RedshiftPlugin extends SpringPlugin {
	...
	public static class SpringPlugin implements FlairFactory {
		...
		public QueryExecutor getExecutor(DataSourceConnection connection, DataSourceDriver driver) {
			return new RedshiftQueryExecutor(strategy, connection, mapper, driver);
		}

		@Override
		public String getExtensionId() {
			return "com.fbi.engine.query.factory.impl.RedshiftFlairFactory";
		}

		@Override
		public String getDescription() {
			return "Extension enabling connection towards Redshift databases";
		}
