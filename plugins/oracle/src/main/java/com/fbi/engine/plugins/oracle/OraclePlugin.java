...
public class OraclePlugin extends SpringPlugin {
	...
	public static class SpringPlugin implements FlairFactory {
		...
		public QueryExecutor getExecutor(DataSourceConnection connection, DataSourceDriver driver) {
			return new OracleQueryExecutor(strategy, connection, mapper, driver);
		}

		@Override
		public String getExtensionId() {
			return "com.fbi.engine.query.factory.impl.OracleFlairFactory";
		}

		@Override
		public String getDescription() {
			return "Extension enabling connection towards Oracle databases";
		}
