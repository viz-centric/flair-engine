...
public class MongoDBPlugin extends SpringPlugin {

	public MongoDBPlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class SpringPlugin implements FlairFactory {
		...
		public QueryExecutor getExecutor(DataSourceConnection connection, DataSourceDriver driver) {
			return new MongoDBQueryExecutor(strategy, connection, mapper, driver);
		}

		@Override
		public String getExtensionId() {
			return "com.fbi.engine.query.factory.impl.MongoDBFlairFactory";
		}

		@Override
		public String getDescription() {
			return "Extension enabling a connection towards Mongodb databases";
		}
	}
