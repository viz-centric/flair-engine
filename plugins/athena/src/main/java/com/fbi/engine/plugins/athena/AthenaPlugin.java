...
public class AthenaPlugin extends SpringPlugin {

	public AthenaPlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class SpringPlugin implements FlairFactory {
		...
		public QueryExecutor getExecutor(DataSourceConnection connection, DataSourceDriver driver) {
			return new AthenaQueryExecutor(strategy, connection, mapper, driver);
		}
