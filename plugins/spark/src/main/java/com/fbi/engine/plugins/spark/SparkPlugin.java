...
public class SparkPlugin extends SpringPlugin {

	public SparkPlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class SpringPlugin implements FlairFactory {
		...
		public QueryExecutor getExecutor(DataSourceConnection connection, DataSourceDriver driver) {
			return new SparkQueryExecutor(strategy, connection, mapper, driver);
		}

		@Override
		public String getExtensionId() {
			return "com.fbi.engine.query.factory.impl.SparkFlairFactory";
		}

		@Override
		public String getDescription() {
			return "Extension enabling connection towards Spark databases";
		}
