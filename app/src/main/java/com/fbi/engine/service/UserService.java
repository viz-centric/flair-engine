...
import com.fbi.engine.domain.Authority;
import com.fbi.engine.domain.User;
import com.fbi.engine.repository.AuthorityRepository;
...
import com.fbi.engine.service.util.RandomUtil;
...
public class UserService {
	...
	public User createUser(UserDTO userDTO) {
		...
		if (userDTO.getAuthorities() != null) {
			Set<Authority> authorities = new HashSet<>();
			userDTO.getAuthorities().forEach(authority -> authorities.add(authorityRepository.findById(authority)
	...
	public Optional<UserDTO> updateUser(UserDTO userDTO) {
		return userRepository.findById(userDTO.getId()).map(user -> {
			...
			userDTO.getAuthorities().stream().map(authorityRepository::findById).map(Optional::get)
