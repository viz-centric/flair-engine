...
public class JsonTypeDescriptor extends AbstractTypeDescriptor<Object> implements DynamicParameterizedType {
	...
	private static final long serialVersionUID = -3364485998704821757L;
	private Class<?> jsonObjectClass;

	public JsonTypeDescriptor() {
		super(Object.class, new MutableMutabilityPlan<Object>() {

			private static final long serialVersionUID = 3499628001016943993L;
	 ...
	 *
	 * As an example, if this is a {@code JavaTypeDescriptor<Integer>} and we are
	 * asked to unwrap the {@code Integer value} as a {@code Long} we would return
	 * something like <code>Long.valueOf( value.longValue() )</code>.
	 *
	...
	/**
	 * Gets called by Hibernate to pass the configured type parameters to the
	 * implementation.
	 *
