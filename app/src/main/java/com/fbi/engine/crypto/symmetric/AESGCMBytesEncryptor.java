...
/**
 * Implementation that follows {@link org.springframework.security.crypto.encrypt.BouncyCastleAesGcmBytesEncryptor}
 * but enables use of other password based derivation functions and not just PBKDF2.
 */
