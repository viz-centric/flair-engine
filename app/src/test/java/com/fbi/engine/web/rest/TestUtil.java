...
public class TestUtil {
    ...
    public static ComparatorType getComparetorType(String opr) {
    	...
    	switch(opr) {
		case "=":	return ComparatorType.EQ;
		case ">":	return ComparatorType.GT;
		case "<":	return ComparatorType.LT;
		case "<=":	return ComparatorType.LTE;
		case ">=":	return ComparatorType.GTE;
		case "<>":	return ComparatorType.NEQ;
