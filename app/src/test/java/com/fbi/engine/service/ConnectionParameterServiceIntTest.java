...
public class ConnectionParameterServiceIntTest {
	...
	public void save() {
		...
		ConnectionParameter p1 = params.stream().filter(i -> i.getName().equals("param1")).findFirst().get();
		assertEquals("value1", p1.getValue());

		ConnectionParameter p2 = params.stream().filter(i -> i.getName().equals("param2")).findFirst().get();
		...
		assertEquals(2, params.size());
		p1 = params.stream().filter(i -> i.getName().equals("param1")).findFirst().get();
		assertEquals("value1", p1.getValue());

		p2 = params.stream().filter(i -> i.getName().equals("param3")).findFirst().get();
