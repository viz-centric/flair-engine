...
public class ResultSetConverterTest {
	...
	public void convert() throws SQLException, IOException {
		...
		Map<?, ?> mapExpected = objectMapper.readValue(
				"{\"data\":{\"type\":0,\"closed\":false,\"warnings\":null,\"cursorName\":null,\"metaData\":{\"columnCount\":1},\"beforeFirst\":false,\"afterLast\":false,\"first\":false,\"last\":false,\"row\":0,\"fetchDirection\":0,\"fetchSize\":0,\"concurrency\":0,\"statement\":null,\"holdability\":0}}",
				Map.class);
	...
	public void convertWithMetadata() throws SQLException, IOException {
		...
		Map<?, ?> mapExpected = objectMapper.readValue(
				"{\"data\":{\"type\":0,\"closed\":false,\"warnings\":null,\"cursorName\":null,\"metaData\":{\"columnCount\":1},\"beforeFirst\":false,\"afterLast\":false,\"first\":false,\"last\":false,\"row\":0,\"fetchDirection\":0,\"fetchSize\":0,\"concurrency\":0,\"statement\":null,\"holdability\":0},\"metadata\":{\"column_name\":\"col_type_nam\"}}",
				Map.class);
		Map<?, ?> mapActual = objectMapper.readValue(result, Map.class);
